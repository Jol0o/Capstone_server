...
export type EventTypeEnum = 'PROVISIONING_TO_SMS_PLATFORM' | 'DEPROVISIONING_FROM_SMS_PLATFORM' | 'PROVISIONING_TO_CAMPAIGN' | 'DEPROVISIONING_FROM_CAMPAIGN' | 'PROVISIONING_TO_VOICE_PLATFORM' | 'DEPROVISIONING_FROM_VOICE_PLATFORM';
